...
def get_scheduler(scheduler_type, optimizer, base_lr, warmup_length, steps, extra_kwargs={}):
    if scheduler_type == "const":
        return const_lr(optimizer, base_lr, warmup_length, steps)
    elif scheduler_type == "const_cooldown":
        return const_lr_cooldown(optimizer, base_lr, warmup_length, steps, **extra_kwargs)
    elif scheduler_type == "cosine":
        return cosine_lr(optimizer, base_lr, warmup_length, steps)
    else:
