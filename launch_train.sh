...
CUDA_VISIBLE_DEVICES=2,3 torchrun --nproc_per_node 2 --master_port=10082 -m train --exp_name mae_base_cvit --config_file GeospatialFM/configs/pretrain_cvit.yaml
