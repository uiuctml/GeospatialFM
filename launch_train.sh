...
CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node 2 --master_port=10082 -m train --exp_name mae_cvit_full --config_file GeospatialFM/configs/pretrain_cvit_v2.yaml --debug
# CUDA_VISIBLE_DEVICES=2,3 torchrun --nproc_per_node 2 --master_port=10082 -m train --exp_name mae_vit_v2 --config_file GeospatialFM/configs/pretrain_vit.yaml
