...
CUDA_VISIBLE_DEVICES=1,0 torchrun --nproc_per_node 2 --master_port=10085 -m train_dist --exp_name mae_base --config_file GeospatialFM/configs/pretrain_cvit.yaml --debug
