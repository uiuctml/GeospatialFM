...
CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node 2 --master_port=10082 -m train --exp_name mae_cvit_full --config_file GeospatialFM/configs/pretrain_cvit_v2.yaml
