...
CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node 2 --master_port=10082 -m train --exp_name mae_cvit_v3 --config_file GeospatialFM/configs/pretrain_cvit.yaml --debug
