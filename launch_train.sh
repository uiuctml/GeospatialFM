...
CUDA_VISIBLE_DEVICES=4,5 torchrun --nproc_per_node 2 --master_port=10082 -m train --exp_name mae_ec_vit_btnk --config_file GeospatialFM/configs/pretrain_cvit.yaml
