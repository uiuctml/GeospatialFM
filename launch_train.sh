...
CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node 2 --master_port=10082 -m train --exp_name mae_base_vit --config_file GeospatialFM/configs/pretrain_vit.yaml --debug
