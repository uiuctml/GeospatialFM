...
CUDA_VISIBLE_DEVICES=2,3 torchrun --nproc_per_node 2 --master_port=10082 -m train --exp_name mae_cvit_1-2-9 \
...
# CUDA_VISIBLE_DEVICES=1,3 torchrun --nproc_per_node 2 --master_port=10086 -m train --exp_name mae_decoder_mm_cvit_1-2-9 \
