...
# CUDA_VISIBLE_DEVICES=2,3 torchrun --nproc_per_node 2 --master_port=10082 -m train --exp_name mae_cvit_v2 --config_file GeospatialFM/configs/pretrain_cvit.yaml
CUDA_VISIBLE_DEVICES=2,3 torchrun --nproc_per_node 2 --master_port=10085 -m train --exp_name mae_vit_btnk_attn_v2 --config_file GeospatialFM/configs/pretrain_cvit.yaml
